...
public class GameTest {
    ...
    public void testNormalGame() {
        ...
        assertTrue(game.getPlayerTurn() == 1);
        game.move(loc1, new Location(0, 1));
        game.build(loc1);
        assertTrue(game.getPlayerTurn() == 2);
        assertFalse(game.getHasGameEnded());
        game.move(loc3, new Location(2, 3));
        game.build(loc3);
        game.move(new Location(0, 1), loc1);
        Location step1 = new Location(1, 0);
        game.build(step1);
        game.move(new Location(2, 3), loc3);
        Location step2 = new Location(3, 2);
        game.build(step2);
        game.move(loc2, new Location(0, 1));
        game.build(step1);
        game.move(loc4, new Location(2, 3));
        game.build(step2);
        game.move(loc1, step1);
        game.build(loc2);
        game.move(loc3, step2);
        game.build(loc4);
        game.move(new Location(0, 1), new Location(0, 2));
        game.build(loc2);
        game.move(new Location(2, 3), new Location(2, 4));
        game.build(loc4);
        game.move(new Location(0, 2), new Location(0, 1));
        game.build(loc2);
        game.move(new Location(2, 4), new Location(2, 3));
        game.build(loc4);
        assertFalse(game.getHasGameEnded());
        game.move(step1, loc2);
        game.build(new Location(0, 2));
        assertTrue(game.getHasGameEnded());
        Location endMove = new Location(2, 4);
        game.move(new Location(2, 3), endMove);
    ...
    public void testGameWithMistakes() {
        ...
        game.build(loc1);
        assertTrue(game.getPlayerTurn() == 2);
        game.move(loc3, new Location(3, 3));
        game.move(loc3, new Location(3, 2));
        game.build(new Location(4, 2));
        assertTrue(game.getPlayerTurn() == 1);
        game.move(loc2, loc1);
        game.build(new Location(1, 0));
        game.move(new Location(3, 2), new Location(3, 1));
        game.build(new Location(4, 2));
        game.move(new Location(0, 1), new Location(0, 2));
        game.build(new Location(1, 0));
        game.move(new Location(3, 1), new Location(3, 2));
        game.build(new Location(4, 2));
        game.move(loc2, new Location(1, 0));
        game.build(loc2);
        game.move(new Location(3, 2), new Location(3, 1));
        game.build(new Location(4, 2));
        game.move(new Location(0, 2), new Location(1, 0));
        game.move(new Location(0, 2), loc2);
        game.build(loc2);
        game.move(new Location(3, 1), new Location(4, 2));
        game.move(new Location(3, 3), new Location(3, 2));
